...
/**
 * A Composable function that displays the screen showing closed ToDos.
 * Users can edit, delete, or create new ToDos. The screen also provides a navigation button to return to the dashboard.
 */
@Composable
fun CloseScreen(
    context: Context,
